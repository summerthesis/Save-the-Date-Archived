...
public class CameraBehaviourT : MonoBehaviour
{
    ...
    private static CameraBehaviourT instance;
    public static CameraBehaviourT GetInstance() { return instance; }
    ...
    private void Start()
    {
        ...
        playerMovementCs = player.GetComponent<PlayerMovementT>();
    }
    ...
    private void MoveToPlayer()
    {
        ...
        {
            transform.Translate(-Vector3.forward * player.GetComponent<PlayerMovementT>().GetMoveSpeed() * dt);
        }
    }
